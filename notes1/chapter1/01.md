...
要在Windows上运行，先下载[Anaconda安装包](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.anaconda.com%2Fdownload%2F)。推荐跟随Anaconda下载页面的Windows安装指导，安装指导在写作本书和读者看到此文的的这段时间内可能发生变化。
...
- scikit-learn和Python机器学习邮件列表，[scikit-learn@python.org](https://links.jianshu.com/go?to=mailto%3Ascikit-learn%40python.org)；
...
- 国际和地区的PyCon会议（[http://pycon.org](https://links.jianshu.com/go?to=http%3A%2F%2Fpycon.org)有完整列表） 。
...
各章的示例数据都存放在GitHub上：[http://github.com/pydata/pydata-book](https://links.jianshu.com/go?to=http%3A%2F%2Fgithub.com%2Fpydata%2Fpydata-book)。下载这些数据的方法有二：使用git版本控制命令行程序；直接从网站上下载该GitHub库的zip文件。如果遇到了问题，可以到我的个人主页，[http://wesmckinney.com/](https://links.jianshu.com/go?to=http%3A%2F%2Fwesmckinney.com%2F)，获取最新的指导。

为了让所有示例都能重现，我已经尽我所能使其包含所有必需的东西，但仍然可能会有一些错误或遗漏。如果出现这种情况的话，请给我发邮件：[wesmckinn@gmail.com](https://links.jianshu.com/go?to=mailto%3Awesmckinn%40gmail.com)。报告本书错误的最好方法是O’Reilly的errata页面，[http://www.bit.ly/pyDataAnalysis_errata](https://links.jianshu.com/go?to=http%3A%2F%2Fwww.bit.ly%2FpyDataAnalysis_errata)。
